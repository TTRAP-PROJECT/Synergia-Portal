...
<div class="bg-gray-100 h-screen flex flex-col max-w-lg mx-auto rounded ">
    <div class="bg-blue-500 p-4 text-white flex justify-between items-center rounded">
        ...
        <span>{{$reservation->service->vendeur->NOMUTILISATEUR." ".$reservation->service->vendeur->PRENOMUTILISATEUR}}</span>
        ...
        <div class="flex flex-col space-y-2">
            ...
            <div class="flex justify-end">
                <div class="bg-blue-200 text-black p-2 rounded-lg max-w-xs">
                    Hey, je voudrais réserver tes services !
                </div>
            </div>
            ...
            @php
                $date = new DateTimeImmutable($reservation->service->DATEPREVUE)
            @endphp
            <!-- Example Received Message -->
            <div class="flex">
                <div class="bg-gray-300 text-black p-2 rounded-lg max-w-xs">
