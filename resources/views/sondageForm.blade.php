                ...
                <form id="login_form" action="api_login" method="POST"
                    ...
                    <div class="flex justify-between items-center mb-3">
                        ...
                        <div class="flex">
                            ...
                            <button type="button" onclick="plus()" class="bg-gray-600 p-1.5 font-bold rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <input class="mb-3 px-2 py-1.5
                          ...
                          focus:ring-1
                          focus:ring-sky-500
                          focus:invalid:border-red-500 focus:invalid:ring-red-500" type="text" name="username" placeholder="Faut t-il éteindre l'incendit tous enflammé ?">

                    <button class="px-4 py-1.5 rounded-md shadow-lg bg-gradient-to-r from-stone-600 to-zinc-300 font-medium text-gray-100 block transition duration-300" type="submit">
                        <span id="login_process_state" class="hidden">Envoi</span>
                        <span id="login_default_state">Partager<span id="subtotal"></span></span>
                    </button>
                </form>
            </div>
        </section>
